        ...
        <div class="">
            <form action="{{ route('Pesanans.update', $Pesanan->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="no_meja" class="form-control" value="{{ $Pesanan->no_meja}}"
                        id="no_meja">
                </div>
                <div class="mb-3">
                    <label for="nama_menu" class="form-label">Nama_Menu</label>
                    <input type="text" name="nama_menu" class="form-control" value="{{ $Pesanan->nama_menu }}"
                        id="nama_menu">
                </div>
                <div class="mb-3">
                    <label for="harga" class="form-label">Harga</label>
                    <input type="number" name="harga" class="form-control" value="{{ $Pesanan->harga }}"
                        id="harga">
                </div>
