...
<body>
    ...
    <div class="p-3">
        ...
        <div class="">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('main.menus.snack.edit', $Snack->id) }}" class="btn btn-primary me-3">Edit</a>
                                <form action="{{ route('main.menus.snack.destroy', $Snack->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
            ...
            <a href="{{ route('main.menus.snack.create') }}" type="button" class="btn btn-primary">Tambah Menu Snack</a>
        </div>
    </div>
</body>
